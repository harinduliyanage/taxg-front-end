...
const CreateChannel = (props: Props) => {
  const { onClose, toggleMobile, accessToken , onCLickStartChat } = props;
  ...
  useEffect(() => {
    ...
    if (connectedUsers.length > 0) {
      ...
      // console.log("test tttttttttttttttttttttttttttttttttt")
  ...
  const findUsers = async () => {
    ...
    try {
      //getting user list
      // const responseGetCOnnectedUsers = await axios.get()
