...
const PrivacyPage = () => {
  return (
    <ContentPageTemplate className="privacy">
      <h1>Privacy policy</h1>
      <p>
        At taxglobal.com, accessible from https://taxglobal.com/, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        taxglobal.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in taxglobal.com. This policy is not applicable to
        any information collected offline or via channels other than this
        website. Our Privacy Policy was created with the help of the Free
        Privacy Policy Generator. Consent
      </p>
      ...
      <p>
        Taxglobal.com follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, taxglobal.com uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of taxglobal.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on taxglobal.com, which are sent
      ...
      <p>
        Note that taxglobal.com has no access to or control over these cookies
      ...
      <p>
        Taxglobal.com's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        taxglobal.com does not knowingly collect any Personal Identifiable
