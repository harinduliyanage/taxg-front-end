...
import entityLogo from "../../assets/images/default_entity.svg";
...
const CreateEntityServiceProvider = () => {
  ...
  const [entitySlugError, setEntitySlugError] = useState<boolean | null>(null);
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit: SubmitHandler<FormData> = async (data: any) => {
    ...
    const uuid = await attributes.sub;
    setCompanyName(data.entityName);
    setCategory(data.category);
    setTagLine(data.tagLine);
    if (selectedBusinessCodeIds.length === 0) {
  ...
  const handleFileInput = (e: any) => {
    // console.log("covUrl",e.target.files[0])
  ...
  async function fetchData() {
    ...
    await axios
      ...
      .then((res: any) => {
        ...
        console.log("business codes : ", res.data.results);
      })
      .catch((error: any) => {
        console.log(error);
      });
  ...
  const entitySlugValidatore = async (val: any) => {
    const configMaster = {
      Accept: "application/json",
      "x-api-key": ENTITY_KEY,
    };
    ...
    if (val !== "" && val) {
      await axios
        .post(
          "https://etcp2if6be.execute-api.us-east-1.amazonaws.com/dev/check-entity-slug",
          {
            entitySlug: val,
          },
        ...
        .then((res: any) => {
          setEntitySlugError(res.data.results.availability);
        })
        .catch((error: any) => {
          console.log(error);
        });
    } else {
      setEntitySlugError(null);
    }
  };
  return (
    <>
                  ...
                  <Col md={"7"}>
                    ...
                    >
                      ...
                      <Form.Group className="form-group">
                        ...
                        <InputGroup className="entity-url">
                          ...
                          <Form.Control
                            ...
                            {...register("urlSlug", {
                              required: true,
                              onChange: (e) => {
                                entitySlugValidatore(e.target.value);
                              },
                            })}
                        ...
                        {entitySlugError === false && (
                          <span className="is-invalid-slug">
                            Entity slug already been taken!
                          </span>
                        )}
                      </Form.Group>
                      <Form.Group className="form-group">
                      ...
                      <Form.Group className="form-group">
                        ...
                        <Select
                          className={`${industryError && "is-invalid"}`}
                          options={
                            industryList &&
                                  ...
                                  {!!file ? (
                                    ...
                                    <>
                                      <input
                                        ...
                                        // {...register("entityLogo", { required: true, onChange: (e) => {
                                        //   handleFileInput(e);
                                        // } })}
                                      />
                                      {profImgError !== "" && (
                                  ...
                                  {!!covFile ? (
                                    ...
                                    <>
                                      <input
                                        ...
                                        className="form-control form-control-lg"
                                        // {...register("entityCoverPhoto", { required: true, onChange: (e) => {
                    ...
                    <Card className="entity-preview">
                      <div className="cover-image">
                        ...
                        <span className="entity-logo">
                          <img src={logoUrl ? logoUrl : entityLogo} alt="" />
                        </span>
                      </div>
                      <Card.Body>
                        ...
                        <p>
                          {tagLine ? tagLine : "Entity tagline will be here"}
                        </p>
                      </Card.Body>
                    </Card>
                  </Col>
...
export default CreateEntityServiceProvider;
